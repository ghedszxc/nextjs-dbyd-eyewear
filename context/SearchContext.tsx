...
export const SearchProvider: React.FC<{ lang?: string; children: React.ReactNode }> = ({ children }) => {
  ...
  return (
    <SearchContext.Provider value={{ searchQuery, setSearchQuery, isSearching, tryClaimResultsHeader, hasOpenAccordion, updateAccordionState, hasSearchResults, updateSearchResults, activeAccordionId, setActiveAccordionId }}>
      {children}
